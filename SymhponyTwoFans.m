...
psi_fan = 1.1;%** %Mellan 0.43 och 0.65 sida 10 designtask2
...
Cooling_pre_HPT = 0.10;
Cooling_post_HPT = 0.10;
...
delta_h_fan = (psi_fan*(u_mid_fan^2)); %designtask2 TOG BORT DIVISION MED TVÅ FÖR ATT SÄGA ATT DET ÄR 2 FLÄKTAR
