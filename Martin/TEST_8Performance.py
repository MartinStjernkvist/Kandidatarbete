...
T_6 = T_turbine
C_P6 = Perf().C_p_prod(T_6)
T_8 = T_turbine
C_P8 = Perf().C_p_prod(T_8)
T_7 = tau_HPT * T_turbine
C_P7 = Perf().C_p_prod(T_7)
T_9 = T_7
C_P9 = Perf().C_p_prod(T_9)
T_5 = Perf().T_5(T_4, T_9, epsilon_reg)
C_P5 = Perf().C_p_air(T_5)
